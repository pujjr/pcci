 ...
 */
@Repository
public class HundredCreditDasRequestDAO extends ParameterizedBaseDAO<HundredCreditDasRequest, Long> {
	/**
	 ...
	 * @return
	 */
	public PagedResult<HundredCreditDasRequest> searchRequestResultRecord(Paged paged, String requestUserId, String name, String cell, String id) {
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(HundredCreditDasRequest.class);
